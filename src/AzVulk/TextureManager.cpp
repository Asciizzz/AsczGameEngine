...
namespace AzVulk {
    ...
    void TextureManager::createTextureImage(const std::string& imagePath) {
        ...
        std::cout << "Texture loaded: " << texWidth << "x" << texHeight << " with " << mipLevels << " mip levels" << std::endl;
        ...
        // Generate mipmaps instead of transitioning to shader read only
    ...
    void TextureManager::createTextureImageView() {
        ...
        viewInfo.subresourceRange.levelCount = mipLevels; // Use all mip levels
    ...
    void TextureManager::createImage(uint32_t width, uint32_t height, uint32_t mipLevels, VkFormat format, VkImageTiling tiling, 
