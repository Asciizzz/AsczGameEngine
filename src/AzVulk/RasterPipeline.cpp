...
namespace AzVulk {
    ...
    void RasterPipeline::createTransparentPipeline() {
        ...
        auto bindingDescription = Az3D::ModelInstance::getBindingDescription();
        auto attributeDescriptions = Az3D::ModelInstance::getAttributeDescriptions();
        ...
        depthStencil.sType = VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO;
        depthStencil.depthTestEnable = VK_TRUE;
        depthStencil.depthWriteEnable = VK_FALSE; // Don't write to depth buffer for transparency
        depthStencil.depthCompareOp = VK_COMPARE_OP_LESS;
        depthStencil.depthBoundsTestEnable = VK_FALSE;
        depthStencil.stencilTestEnable = VK_FALSE;
