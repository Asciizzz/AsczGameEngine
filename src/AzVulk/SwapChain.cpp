...
void SwapChain::drawFrame(VkPipeline graphicsPipeline) {
...
void SwapChain::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex, VkPipeline graphicsPipeline) {
