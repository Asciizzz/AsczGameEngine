...
// Instance data
layout(location = 2) in uvec4 properties; // <materialIndex>, <indicator>, <empty>, <empty>
layout(location = 3) in vec4 mat4_row0;  // Row 0: [m00, m01, m02, m03]
layout(location = 4) in vec4 mat4_row1;  // Row 1: [m10, m11, m12, m13]
layout(location = 5) in vec4 mat4_row2;  // Row 2: [m20, m21, m22, m23]
layout(location = 6) in vec4 mat4_row3;  // Row 3: [m30, m31, m32, m33]
